      ...
      <div class="container">
        <div class="page-header">
          <h5>Management Page</h5>
           ...
           <div id="container">
            <div id="row-fluid">
             <p>You can upload file and mange the picture here.</p>
             <p>Also you can confirm where is the picture which I uploaded.<br />
           </div>
          </div>
         <div>
         <h3>Management Photo</h3>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="span3">
           ...
           <div class="span3">
            <h4>Subscribe</h4>
             <a href="subform.html"><img src="http://yukycohamabe.ciao.jp/artist_boxes/img/btn2.png" width: 230px; alt="Email" / onmouseover="this.src='img/btn2_ov.png'" onmouseout="this.src='img/btn2.png'"></a>
          </div>
         </div>
      </div>
      <hr class="footer">
