...
$site_top = "http://yukycohamabe.ciao.jp/artist_boxes/index.html";
...
$thanksPage = "http://yukycohamabe.ciao.jp/artist_boxes/thanks.html";
...
$refrom_name = "Yukyco Business";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "Thank you ! :) ";
...
Thank you for registration to art box.
会員登録のお申し込みを受け付けました。

Art BoxのログインページのIDとPASSWORDをお知らせします。
ID : admin  Password : 1111

Chat Roomへのログインパスワード
User ID : lalala  Password : 0123

本日より新着情報のページにご自由にご投稿して頂けます。
From today you can post your news freely.

＊尚わいせつな画像やヌード、暴力的な画像と記事はこちら
の判断で削除させて頂きますので予めご了承くださいませ。
＊Attention＊
An obscene image and nude or a violent image and the article 
would be delete by our judgment. 

It is the contents which you are about to send.
送信内容は以下になります。


＊登録解除は下記メールアドレスまでご連絡ください。
...
──────────────────────
Art Box by Yukyco Business
E-mail：info@yukycohamabe.ciao.jp
URL: http://yukycohamabe.ciao.jp/artist_boxes
──────────────────────
...
<?php }else{ ?>
<h3>Confirmation</h3>
<p align="center">Please push the left button to look forward.</p>
